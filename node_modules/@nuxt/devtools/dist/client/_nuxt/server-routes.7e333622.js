...
`).map(I=>`  ${I}`).join(`
`)}
}`:"";return s.push({name:"useFetch",lang:"javascript",docs:ye.nuxt.useFetch,code:`const { data, pending, error, refresh } = useFetch('${ne.value}'${N})`}),s.push({name:"$fetch",lang:"javascript",docs:ye.nuxt.$fetch,code:`await $fetch('${ne.value}'${N})`}),s}),Ne=V(()=>{const s=[];return z.value.length&&s.push({name:"Params",slug:"params",length:z.value.length}),s.push({name:"Query",slug:"query",length:x.query.length}),q.value&&s.push({name:"Body",slug:"body",length:x.body.length}),s.push({name:"Headers",slug:"headers",length:x.headers.length}),s.push({name:"Cookies",slug:"cookies"}),s.push({name:"Snippets",slug:"snippet"}),s}),Z=L(Ee());function Ee(){return document.cookie.split("; ").map(s=>{const[l,b]=s.split("=");return{key:l,value:b}})}const W=de({key:"",value:""});function ie(s,l){if(!s)return;const b=Z.value.find(I=>I.key===s),N=kt(s);b!==void 0?l===void 0&&(Z.value=Z.value.filter(I=>I.key!==s)):(Z.value.push({key:s,value:l}),W.key="",W.value=""),N.value=l}Ye(()=>{H.value==="json"&&typeof $.value=="string"&&($.value=JSON.parse($.value))});const je=Ze();return(s,l)=>{const b=Ce,N=Te,I=ke,P=ce,Oe=we,ve=Ie,Pe=ut,Le=$e,Be=tt,ue=Se,qe=dt,Ae=ct,he=xe("tooltip");return o(),p("div",It,[d("div",Dt,[d("div",Nt,[s.route.method?(o(),C(b,{key:0,class:E(("getRequestMethodClass"in s?s.getRequestMethodClass:e(le))(e(v))),"pointer-events-none":"",tabindex:"-1"},{default:k(()=>[F(j(e(v).toUpperCase()),1)]),_:1},8,["class"])):(o(),C(N,{key:1,modelValue:e(v),"onUpdate:modelValue":l[0]||(l[0]=a=>te(v)?v.value=a:null),class:E(("getRequestMethodClass"in s?s.getRequestMethodClass:e(le))(e(v)))},{default:k(()=>[(o(),p(R,null,A(O,a=>d("option",{key:a,class:E(("getRequestMethodClass"in s?s.getRequestMethodClass:e(le))(a))},j(a.toUpperCase()),3)),64))]),_:1},8,["modelValue","class"])),d("div",Et,[f(I,{"model-value":e(ne),disabled:"","flex-auto":"","font-mono":"",p:"x5 y2",n:"primary xs"},null,8,["model-value"]),ae((o(),C(b,{title:"Copy URL",absolute:"","right-2":"","top-1.7":"",n:"xs blue",onClick:l[1]||(l[1]=a=>e(je)(e(pe)))},{default:k(()=>[f(P,{icon:"carbon:copy"})]),_:1})),[[he,"Copy URL"]])]),f(b,{n:"primary solid",onClick:fe},{default:k(()=>[f(P,{icon:"carbon:send"})]),_:1})])]),d("div",jt,[(o(!0),p(R,null,A(e(Ne),a=>(o(),C(b,{key:a.slug,class:E(e(S)===a.slug?"text-primary n-primary":"border-transparent shadow-none"),onClick:Q=>S.value=a.slug},{default:k(()=>[f(P,{icon:("ServerRouteTabIcons"in s?s.ServerRouteTabIcons:e(Re))[a.slug]},null,8,["icon"]),F(" "+j(a.name)+" "+j(a?.length?`(${a.length})`:"")+" ",1),d("span",null,j(e(g)[a.slug]?.length?`(${e(g)[a.slug].length})`:""),1)]),_:2},1032,["class","onClick"]))),128)),Ot,ae((o(),C(b,{title:"Open in Editor",onClick:l[2]||(l[2]=a=>e(G)(s.route.filepath))},{default:k(()=>[f(P,{icon:"carbon-launch"})]),_:1})),[[he,"Open in Editor"]])]),e(S)==="params"?(o(),p("div",Pt,[(o(!0),p(R,null,A(e(z),a=>(o(),p(R,{key:a},[d("div",Lt,j(a),1),f(I,{modelValue:e(c)[a],"onUpdate:modelValue":Q=>e(c)[a]=Q,placeholder:a,"flex-1":""},null,8,["modelValue","onUpdate:modelValue","placeholder"])],64))),128))])):D("",!0),e(S)==="cookies"?(o(),p("div",Bt,[(o(!0),p(R,null,A(e(Z),a=>(o(),p("div",{key:a.key,flex:"~ gap-4 items-center"},[f(I,{placeholder:"Key...","model-value":a.key,disabled:"","op-70":""},null,8,["model-value"]),f(I,{placeholder:"Value...","model-value":a.value,"flex-1":"",n:"primary",onInput:Q=>ie(a.key,Q.target?.value)},null,8,["model-value","onInput"]),f(b,{title:"Delete",n:"red",onClick:Q=>ie(a.key,void 0)},{default:k(()=>[f(P,{icon:"i-carbon-delete"})]),_:2},1032,["onClick"])]))),128)),d("div",qt,[f(I,{modelValue:e(W).key,"onUpdate:modelValue":l[3]||(l[3]=a=>e(W).key=a),placeholder:"Key",n:"primary","flex-1":""},null,8,["modelValue"]),f(I,{modelValue:e(W).value,"onUpdate:modelValue":l[4]||(l[4]=a=>e(W).value=a),placeholder:"Value",n:"primary","flex-1":""},null,8,["modelValue"]),f(b,{title:"Add",n:"primary",onClick:l[5]||(l[5]=a=>ie(e(W).key,e(W).value))},{default:k(()=>[f(P,{icon:"i-carbon-save"})]),_:1})])])):D("",!0),f(e(n),null,{default:k(()=>[f(ve,{modelValue:e(K),"onUpdate:modelValue":l[8]||(l[8]=a=>te(K)?K.value=a:null),default:{type:"string"},"max-h-xs":"","of-auto":""},{default:k(()=>[e(g)[e(S)]?.length?(o(),p(R,{key:0},[d("div",At,[Mt,Ft,f(Oe,{icon:"i-carbon-edit",onClick:l[6]||(l[6]=a=>h("open-default-input"))}),Ht]),f(ve,{modelValue:e(g)[e(S)],"onUpdate:modelValue":l[7]||(l[7]=a=>e(g)[e(S)]=a),disabled:"",p0:""},null,8,["modelValue"])],64)):D("",!0)]),_:1},8,["modelValue"])]),_:1}),e(S)==="snippet"?(o(),p("div",zt,[e(me).length?(o(),C(Pe,{key:0,"code-snippets":e(me)},null,8,["code-snippets"])):D("",!0)])):e(K)?(o(),p("div",Wt,[e(S)==="body"?(o(),p(R,{key:0},[d("div",Gt,[(o(),p(R,null,A(oe,a=>d("button",{key:a,px4:"",py2:"",border:"r base",hover:"bg-active",class:E({"border-b":a!==e(H)}),onClick:Q=>H.value=a},[d("div",{class:E({op30:a!==e(H)}),"font-mono":""},j(a),3)],10,Jt)),64)),Kt]),e(H)==="input"?(o(),C(e(w),{key:0})):e(H)==="json"?(o(),C(e(pt),et({key:1,modelValue:e($),"onUpdate:modelValue":l[9]||(l[9]=a=>te($)?$.value=a:null),class:[[s.$colorMode.value==="dark"?"jse-theme-dark":"light"],"json-editor-vue of-auto text-sm outline-none"]},s.$attrs,{mode:"text","navigation-bar":!1,indentation:2,"tab-size":2}),null,16,["modelValue","class"])):D("",!0)],64)):(o(),C(e(w),{key:1}))])):D("",!0),e(U)?e(i)?(o(),C(Be,{key:5,"z-10":"","flex-auto":"","backdrop-blur":""},{default:k(()=>[F(" Fetching... ")]),_:1})):(o(),p(R,{key:6},[d("div",Qt,[Xt,e(t).error?(o(),C(ue,{key:0,"bg-red-400:10":"","text-red-400":""},{default:k(()=>[F(" Error ")]),_:1})):D("",!0),f(ue,{class:E({"bg-orange-400:10 text-orange-400":e(t).error,"bg-green-400:10 text-green-400":!e(t).error})},{default:k(()=>[F(j(e(t).statusCode),1)]),_:1},8,["class"]),e(t).contentType?(o(),p("code",Yt,j(e(t).contentType),1)):D("",!0),e(t).contentType==="application/json"?(o(),C(qe,{key:2,getter:()=>({input:e(u)})},null,8,["getter"])):D("",!0),Zt,eo,f(ue,{"bg-green-400:10":"","text-green-400":""},{default:k(()=>[F(j(e(t).fetchTime)+" ms ",1)]),_:1})]),e(y)==="pdf"?(o(),p("div",to,[d("div",oo,[d("object",{data:e(u),type:"application/pdf","flex-auto":"",width:"100%",height:"100%",rounded:""},null,8,no)])])):e(y)!=="media"?(o(),C(Ae,{key:1,"flex-auto":"","overflow-auto":"","py-2":"",code:e(u),lang:e(y)},null,8,["code","lang"])):(o(),p("div",so,[d("div",lo,[e(t).contentType.includes("image")?(o(),p("img",{key:0,rounded:"",src:e(u)},null,8,ao)):(o(),p("video",ro,[d("source",{src:e(u),type:"video/mp4"},null,8,io)]))])]))],64)):(o(),C(Le,{key:4},{default:k(()=>[f(b,{n:"primary",onClick:fe},{default:k(()=>[f(P,{icon:"carbon:send"}),F(" Send request ")]),_:1})]),_:1}))])}}}),co={flex:"~ gap1","text-sm":""},po={key:0,op50:""},fo={op50:""},mo=d("span",{op75:""},"Select a route to start",-1),vo=d("div",{p4:"",border:"b base"},[d("span",{"text-lg":""},"Default Inputs"),d("br"),d("span",{"text-white":"",op50:""},"Merged as default for every request in DevTools")],-1),Uo=re({__name:"server-routes",setup(r){const h=L(!1),m=ot(),n=be(),{selectedRoute:w,view:_,inputDefaults:t}=Ve("serverRoutes"),y=V(()=>{!n.value&&w.value&&(n.value=w.value.filepath);const v=m.value?.find(c=>c.filepath===n.value);return n.value!==w.value?.filepath&&v&&(w.value=v),v}),u=L(""),i=V(()=>new nt(m.value||[],{keys:["method","route"],shouldSort:!0})),U=V(()=>m.value?u.value?i.value.search(u.value).map(c=>c.item):m.value:[]),G=V(()=>{const v=[],c=(x,$)=>{x.routes=x.routes||[],x.routes.push($)};return U.value.forEach(x=>{const $=x.filepath.split("/"),g=$.slice($.indexOf("server")+1);g.length>0&&g[g.length-1].includes(".")&&g.pop();let O=null;if(g.forEach(B=>{const q=O?O.routes?.find(S=>S.route===B):v.find(S=>S.route===B);if(q)O=q;else{const S={route:B,filepath:B.replace(/\W/g,"-").toLowerCase(),type:"collection",routes:[]};O?c(O,S):v.push(S),O=S}}),x.type==="runtime"){const B=v.find(q=>q.route==="runtime");if(B)c(B,x);else{const q={route:"runtime",filepath:"runtime",type:"collection",routes:[x]};v.push(q)}}else O?c(O,x):v.push(x)}),v});function M(){_.value=_.value==="tree"?"list":"tree"}function z(v){return v.charAt(0).toUpperCase()+v.slice(1)}return(v,c)=>{const x=we,$=rt,g=Ue,O=uo,B=at,q=$e,S=st,oe=Ie,H=ft,K=mt,X=xe("tooltip");return o(),p(R,null,[f(S,{"storage-key":"tab-server-routes"},{left:k(()=>[f($,{search:e(u),"onUpdate:search":c[1]||(c[1]=T=>te(u)?u.value=T:null),pb2:""},{actions:k(()=>[ae(f(x,{"text-lg":"",icon:e(_)==="list"?"i-carbon-list":"i-carbon-tree-view-alt",title:"Toggle view",onClick:M},null,8,["icon"]),[[X,"Toggle View"]]),ae(f(x,{"text-lg":"",icon:"i-carbon-cics-sit-overrides",title:"Default Inputs",onClick:c[0]||(c[0]=T=>h.value=!e(h))},null,512),[[X,"Default Inputs"]])]),default:k(()=>[d("div",co,[e(u)?(o(),p("span",po,j(e(U).length)+" matched · ",1)):D("",!0),d("span",fo,j(e(m)?.length)+" routes in total",1)])]),_:1},8,["search"]),(o(!0),p(R,null,A(e(_)==="tree"?e(G):e(U),T=>(o(),C(g,{key:T.filepath,item:T},null,8,["item"]))),128))]),right:k(()=>[(o(),C(lt,{max:10},[e(y)?(o(),C(O,{key:e(y).filepath,route:e(y),onOpenDefaultInput:c[2]||(c[2]=T=>h.value=!0)},null,8,["route"])):D("",!0)],1024)),e(y)?D("",!0):(o(),C(q,{key:0},{default:k(()=>[f(B,{px6:"",py2:""},{default:k(()=>[mo]),_:1})]),_:1}))]),_:1}),f(K,{modelValue:e(h),"onUpdate:modelValue":c[3]||(c[3]=T=>te(h)?h.value=T:null),"auto-close":"","max-w-xl":"","min-w-xl":"",onClose:c[4]||(c[4]=T=>h.value=!1)},{default:k(()=>[d("div",null,[vo,(o(!0),p(R,null,A(Object.keys(e(t)),T=>(o(),C(H,{key:T,text:`${z(T)} ${e(t)[T].length?`(${e(t)[T].length})`:""}`,padding:!1,icon:("ServerRouteTabIcons"in v?v.ServerRouteTabIcons:e(Re))[T]},{default:k(()=>[f(oe,{modelValue:e(t)[T],"onUpdate:modelValue":Y=>e(t)[T]=Y,py0:"",default:{type:"string"}},null,8,["modelValue","onUpdate:modelValue"])]),_:2},1032,["text","icon"]))),128))])]),_:1},8,["modelValue"])],64)}}});export{Uo as default};
