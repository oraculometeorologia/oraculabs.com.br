import { d as defineCommand, c as consola } from '../shared/nuxi.46d00f54.mjs';
import 'node:util';
import 'node:path';
import 'node:process';
import 'node:tty';
...
import { c } from '../shared/nuxi.5362f0d4.mjs';
import { createNuxtDevServer } from './dev2.mjs';
import { r as resolve } from '../shared/nuxi.dcd5f40f.mjs';
import 'node:url';
import 'node:events';
import '../shared/nuxi.467f6790.mjs';
import 'events';
import 'fs';
import 'path';
import 'util';
import 'stream';
import '../shared/nuxi.ea7eac74.mjs';
import '../shared/nuxi.7b65c5e0.mjs';
...
import '../shared/nuxi.dfca5e6b.mjs';
import '../shared/nuxi.28eabe2a.mjs';
...
const devChild = defineCommand({
  ...
  async run(ctx) {
    ...
    const devProxyOptions = JSON.parse(process.env.__NUXT_DEV_PROXY__ || "null") || {};
