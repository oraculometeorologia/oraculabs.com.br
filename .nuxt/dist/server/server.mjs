import { reactive, hasInjectionContext, getCurrentInstance, inject, toRef, h, isReadonly, version, unref, defineComponent, computed, ref, resolveComponent, isRef, isShallow, isReactive, toRaw, mergeProps, withCtx, createVNode, createTextVNode, useSSRContext, defineAsyncComponent, provide, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "ofetch";
import { useRuntimeConfig as useRuntimeConfig$1 } from "#internal/nitro";
import { createHooks } from "hookable";
import { getContext } from "unctx";
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, isEqual, stringifyParsedURL, stringifyQuery, parseQuery, withTrailingSlash, withoutTrailingSlash } from "ufo";
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderStyle, ssrRenderSlot, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
const Navbar_vue_vue_type_style_index_0_scoped_b375a234_lang = "";
...
const Hero_vue_vue_type_style_index_0_scoped_8cf4f02c_lang = "";
const _sfc_main$d = {};
...
const ComoPodeAjudar_vue_vue_type_style_index_0_lang = "";
const _sfc_main$b = {};
...
const Clients_vue_vue_type_style_index_0_lang = "";
const _sfc_main$9 = {
  __name: "Clients",
...
const FaleConosco_vue_vue_type_style_index_0_scoped_0b9a5df8_lang = "";
const _sfc_main$8 = {};
...
const Newsletter_vue_vue_type_style_index_0_scoped_a2271baa_lang = "";
const _sfc_main$7 = {};
...
const VoltarParaTopo_vue_vue_type_style_index_0_scoped_b4685d7c_lang = "";
const _sfc_main$6 = {};
...
const Whatsapp_vue_vue_type_style_index_0_scoped_1ea558e5_lang = "";
const _sfc_main$5 = {};
...
const FixedComponents_vue_vue_type_style_index_0_scoped_90e84a7c_lang = "";
const _sfc_main$4 = {};
...
const FooterApp_vue_vue_type_style_index_0_scoped_dad46089_lang = "";
const _sfc_main$3 = {};
...
const app_vue_vue_type_style_index_0_scoped_80d7fd90_lang = "";
const _sfc_main$2 = {
  __name: "app",
  __ssrInlineRender: true,
  setup(__props) {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-dabdff7e.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-e991f108.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-02525563.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
